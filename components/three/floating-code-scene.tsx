 ...
 */
function FloatingShape({ position, color, size = 1 }: {
...
/**
 * Three.js Floating Code Scene
 * 3D background with floating geometric shapes
 * Adds visual interest to the hero section
 */
  ...
  return (
    <div className="absolute inset-0 -z-10">
      ...
      >
        ...
        {/* Floating shapes with sage and gold colors */}
